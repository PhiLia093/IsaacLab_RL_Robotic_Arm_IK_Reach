...
##
@configclass
class RlUr10IkSceneCfg(InteractiveSceneCfg):
...
@configclass
class RlUr10IkEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the reach end-effector pose tracking environment."""

    # Scene settings - how many robots, how far apart?
    scene = RlUr10IkSceneCfg(num_envs=2000, env_spacing=2.5)
    # Basic settings
...
class RlUr10IkEnvCfg_PLAY(RlUr10IkEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
